...
namespace TailwindPOS
{
		...
		: System.Windows.Forms.Form
	{
		...
		private void cbCreditCard_Click(Object eventSender, EventArgs eventArgs)
		{
			...
			{
				MessageBox.Show(resultString, AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
			}
		}
		...
		private void cbFinishPayment_Click(Object eventSender, EventArgs eventArgs)
		{
			...
			{
				MessageBox.Show("Payment is not complete. Press Cancel to Abort", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
			}
		}
