...
namespace TailwindPOS
{
	internal static class MainModule
	{
		...
		public static int PRESET_TERMINALID = 0;

		// The Collection of POS users ID used to skip the log in process
		private static OrderedDictionary _POSSystems = null;
		...
		private static POSSystems _CurrentPOS = null;
