...
namespace TailwindPOS
{
		...
		: System.Windows.Forms.Form
	{
		...
		private void cbPayment_Click(Object eventSender, EventArgs eventArgs)
		{
			...
			if (items.Count > 0)
			{
				...
				if (pay.PaymentDone)
				{
					...
					{
						MessageBox.Show("Error saving sale", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
					}
			...
			{
				MessageBox.Show("Error no items registered", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
			}
		}
		...
		{
			MessageBox.Show("Printing Last Receipt", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
		}
		...
		{
			DialogResult result = MessageBox.Show("Are you sure you want to cancel this sale?", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()), MessageBoxButtons.YesNo);
