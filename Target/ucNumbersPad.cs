...
namespace TailwindPOS
{
   ...
   {
      [field:System.NonSerialized]public event OnNumberHandler OnNumber;

      public delegate void OnNumberHandler(Object Sender, OnNumberEventArgs e);
      [field:System.NonSerialized]public event OnBackHandler OnBack;

      public delegate void OnBackHandler(Object Sender, EventArgs e);
      [field:System.NonSerialized]public event OnEnterEventHandler OnEnterEvent;

      public delegate void OnEnterEventHandler(Object Sender, OnEnterEventEventArgs e);

      [Intercepted]
      private bool m_ShowChars { get; set; } = false;
