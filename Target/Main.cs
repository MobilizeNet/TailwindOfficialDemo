...
namespace TailwindPOS
{
   ...
   internal static class MainModule
   {
      ...
      internal static void EndShiftWithAmount(int POSID, int UserID, dynamic ShiftID, decimal StartCash)
      {
      	object EndCash = null;
      	object Endshift = null;
      	object StartShift = null;
      	ShiftID.RefValue = DateTime.Parse(DateTimeHelper.ToString(ShiftID.RefValue));
      	DbConnection conn = OpenConnection();
      ...
      internal static bool FindProductByCode(string productCode, dynamic ProductDescription, dynamic ProductPrice)
      {
      	bool result = false;
      	...
      	if (xmlhttp.status == 200)
         {
         	...
         	ProductDescription.RefValue = ExtractData("name", xmlhttp.responseText, false);
         	ProductPrice.RefValue = Decimal.Parse(ExtractData("price", xmlhttp.responseText, true), NumberStyles.Currency | NumberStyles.AllowExponent);
         	result = true;
         }
         else
         {
      ...
      internal static void ReadConfig()
      {
      	...
      	string tempRefParam2 = ".\\TailwindPOS.ini";
            ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=TailwindPOS.mdb";
         string tempRefParam3 = "Products";
         string tempRefParam4 = ".\\TailwindPOS.ini";
            URL_PRODUCT_API = "http://192.168.3.200:5200/v1/products/";
      ...
      internal static void RegisterBreakEnd(int POSID, int ShiftID, int BreakId, dynamic EndTime)
      {
      	object FirstName = null;
      	EndTime.RefValue = DateTime.Parse(DateTimeHelper.ToString(EndTime.RefValue));
      	...
      	TempParameter_4.Direction = ParameterDirection.Input;
      	TempParameter_4.Size = 0;
      	TempParameter_4.Value = EndTime.RefValue;
      ...
      internal static int RegisterBreakStart(int POSID, int ShiftID, dynamic StartTime)
      {
      	int result = 0;
      	StartTime.RefValue = DateTime.Parse(DateTimeHelper.ToString(StartTime.RefValue));
      	DbConnection conn = OpenConnection();
      	DbCommand objcommand = UpgradeHelpers.DB.AdoFactoryManager.GetFactory().CreateCommand();
      	objcommand.Connection = conn;
      	UpgradeHelpers.DB.DbConnectionHelper.ResetCommandTimeOut(objcommand);
      	...
      	TempParameter_3.Direction = ParameterDirection.Input;
      	TempParameter_3.Size = 0;
      	TempParameter_3.Value = StartTime.RefValue;
      	objcommand.Parameters.Add(TempParameter_3);
      	UpgradeHelpers.DB.TransactionManager.SetCommandTransaction(objcommand);
      	objcommand.ExecuteNonQuery();
      ...
      internal static int StartShiftWithAmount(int POSID, int UserID, dynamic StartShift, decimal StartCash)
      {
      	int result = 0;
      	StartShift.RefValue = DateTime.Parse(DateTimeHelper.ToString(StartShift.RefValue));
      	DbConnection conn = OpenConnection();
      	// We need to insert the shift information
      	DbCommand command = UpgradeHelpers.DB.AdoFactoryManager.GetFactory().CreateCommand();
      	command.Connection = conn;
      	...
      	TempParameter_3.Direction = ParameterDirection.Input;
      	TempParameter_3.Size = 0;
      	TempParameter_3.Value = StartShift.RefValue;
      	command.Parameters.Add(TempParameter_3);
      	DbParameter TempParameter_4 = null;
      	TempParameter_4 = command.CreateParameter();
