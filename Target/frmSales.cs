...
namespace TailwindPOS
{
      ...
      : Mobilize.Web.Form
   {
      ...
      private void cbPayment_Click(Object eventSender, EventArgs eventArgs)
      {
         ...
         {
            Mobilize.Web.MessageBox.Show("Error no items registered", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
         }
      }
      ...
      {
         Mobilize.Web.MessageBox.Show("Printing Last Receipt", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()));
      }
      ...
      {
         Mobilize.Web.DialogResult result = Mobilize.Web.MessageBox.Show("Are you sure you want to cancel this sale?", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()), Mobilize.Web.MessageBoxButtons.YesNo);
