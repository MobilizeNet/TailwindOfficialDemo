...
namespace TailwindPOS
{
      ...
      : Mobilize.Web.Form
   {
      ...
      {
         //Cust No
         fgCustomers.SetCellValue(0, 0, "Custo No");
         //First Name
         fgCustomers.SetCellValue(1, 0, "First Name");
         //Last Name
         fgCustomers.SetCellValue(2, 0, "Last Name");
         //Email
         fgCustomers.SetCellValue(3, 0, "Email");
         //Street1
         fgCustomers.SetCellValue(4, 0, "Street 1");
      }
      ...
      public void SearchCustomer(string customerInfo)
      {
         ...
         while ( !rs.EOF )
         {
            ...
            fgCustomers.SetCellValue(0, index, (Convert.IsDBNull(rs["CustomerID"])) ? "" : Convert.ToString(rs["CustomerID"]));
            //First Name
            //UPGRADE_WARNING: (1049) Use of Null/IsNull() detected. More Information: https://docs.mobilize.net/vbuc/ewis#1049
            fgCustomers.SetCellValue(1, index, (Convert.IsDBNull(rs["FirstName"])) ? "" : Convert.ToString(rs["FirstName"]));
            //Last Name
            //UPGRADE_WARNING: (1049) Use of Null/IsNull() detected. More Information: https://docs.mobilize.net/vbuc/ewis#1049
            fgCustomers.SetCellValue(2, index, (Convert.IsDBNull(rs["LastName"])) ? "" : Convert.ToString(rs["LastName"]));
            //Email
            //UPGRADE_WARNING: (1049) Use of Null/IsNull() detected. More Information: https://docs.mobilize.net/vbuc/ewis#1049
            fgCustomers.SetCellValue(3, index, (Convert.IsDBNull(rs["Email"])) ? "" : Convert.ToString(rs["Email"]));
            //Street1
            //UPGRADE_WARNING: (1049) Use of Null/IsNull() detected. More Information: https://docs.mobilize.net/vbuc/ewis#1049
            fgCustomers.SetCellValue(4, index, (Convert.IsDBNull(rs["StreetAddress1"])) ? "" : Convert.ToString(rs["StreetAddress1"]));
            index++;
            rs.MoveNext();
         }
      }
